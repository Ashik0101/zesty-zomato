...
class DishInventory:
    ...
    def add_dish(self,dish_id, name, price,stock, availability):
        ...
        print("Dish added to the inventory. 😎✌️")
        self.save_to_file()
    ...
    def romove_dish(self,dish_id):
        for dish in self.inventory:
            if dish['id'] == dish_id:
               ...
               self.save_to_file()
               print("Dish removed successfully!✌️✌️")
               break
        else:
    ...
    def change_order_status(self,order_id,status):
        ...
        for order in self.orders:
            if order['order_id'] == order_id:
                ...
                order['status'] = status
                self.save_orders_to_file()
                print("Order status has been updated successfully!✌️✌️")
